 ...
 * @author Alok Hirwe
 */
public class Request_done extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    ...
    {
        System.out.println("Request done (user)");
        ...
        Main m=new Main();
        boolean done=m.model_request_done(req_id,user_id);
        ...
        if(done)
        {
               ...
               System.out.println("Inside Notification user");
